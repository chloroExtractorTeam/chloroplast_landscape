...
\author{Simon Pfaff}
\date{\today}
\title{Seperating the good from the bad... Exploring the genomic landscape of chloroplasts from genomic sequencing datatreduction}
\hypersetup{
  pdfkeywords={},
  pdfsubject={},
...
\maketitle
\begin{center}
\includegraphics[width=.3\linewidth]{./neuSIEGEL.pdf}\\[1cm]
